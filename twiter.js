async function enviarScript(scriptText){
	...
	textarea = main.querySelector(`div[data-testid="tweetTextarea_0RichTextInputContainer"]`)
	...
	for(const line of lines){
		...
		setTimeout(() => {
			(main.querySelector(`div [data-testid="tweetButtonInline"]`) || main.querySelector(`[data-icon="send"]`)).click();
		}, 100);
